...
permalink: /careers/
---
<img class="page-banner" src="{{ "/img/CLEANZONE_crop.JPG" | relative_url }}" alt="The clean work area in the AIM Lab">
<header class="page-heading"><p class="eyebrow">Opportunities at AIM Lab</p><h1>Join Us</h1></header>

<div class="careers-layout">
  <div class="prose reading-width">
    <h2>Graduate research &amp; post-doctoral opportunities</h2>
    ...
    <ul class="callout">
        <li class="note">Note 1: We admit graduate students through the <a href="https://www.bme.ubc.ca/" target="_blank" rel="noopener noreferrer">School of Biomedical Engineering</a>, the <a href="http://www.bioinformatics.ubc.ca/" target="_blank" rel="noopener noreferrer">Graduate Program in Bioinformatics</a>, and the <a href="https://pathology.ubc.ca/" target="_blank" rel="noopener noreferrer">Department of Pathology & Laboratory Medicine</a>. In very special cases, we may admit students through the <a href="https://ece.ubc.ca/" target="_blank" rel="noopener noreferrer">Electrical & Computer Engineering Department</a>.</li>
    ...
    <p>To view the job description and apply, please visit: <a href="https://docs.google.com/forms/d/1ZitNWNpyYSc4i54Qe4RRTurcqm9U7_C_B8SXtBVtwKE/viewform?edit_requested=true" target="_blank" rel="noopener noreferrer">View the position and apply</a>.</p>
  ...
  <aside class="careers-contact"><h2>General Inquiries</h2><p>Please contact Hossein Farahani.</p><a href="mailto:h.farahani@ubc.ca">h.farahani@ubc.ca</a></aside>
</div>
